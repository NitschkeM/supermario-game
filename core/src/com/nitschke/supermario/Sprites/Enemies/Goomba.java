package com.nitschke.supermario.Sprites.Enemies;
 ...
 */
public class Goomba extends com.nitschke.supermario.Sprites.Enemies.Enemy
{
    private float stateTime;
    private Animation<TextureRegion> walkAnimation;     // Me: Added <TextureRegion>
